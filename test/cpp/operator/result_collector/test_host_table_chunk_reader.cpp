...
TEST_CASE("Host table metadata offsets match packed data",
          "[operator][result_collector][host_table_metadata]")
{
          ...
          "[operator][result_collector][host_table_chunk_reader]")
{
  ...
  sirius::op::result::host_table_chunk_reader reader(host_table, types);
